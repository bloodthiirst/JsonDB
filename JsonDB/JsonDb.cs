...
using JsonDB.CustomJsonConverter;
...
namespace JsonDB
{
    ...
    {
        [JsonProperty]
        private List<Type> EntitiesTypes { get; set; }

        [JsonProperty]
        private Dictionary<Type, int> IndexTracker { get; set; }

        private Dictionary<Type, EntityInfo> EntityInfos { get; set; }

        [JsonProperty]
        private Dictionary<Type, HashSet<IDbEntity>> Database { get; set; }

        public event Action<JsonDb> OnDatabaseChanged;
        ...
        static JsonDb()
        {
            ...
            {
                new IDbReferenceConverter()
            };
        }

        private JsonDb()
        {
            EntitiesTypes = new List<Type>();
            Database = new Dictionary<Type, HashSet<IDbEntity>>();
            EntityInfos = new Dictionary<Type, EntityInfo>();
            IndexTracker = new Dictionary<Type, int>();
        }
        ...
        /// <summary>
        /// return the Json representaion of the Db        
        /// </summary>
        /// <returns></returns>
        public string Save()
        {
